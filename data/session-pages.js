...
export const SESSION_PAGES = {
  ...
  'microsoft.com': { url: 'https://account.microsoft.com/devices', label: 'Your devices', revoke: 'unknown' },
  'live.com': { url: 'https://account.microsoft.com/devices', label: 'Your devices', revoke: 'unknown' },
  'outlook.com': { url: 'https://account.microsoft.com/devices', label: 'Your devices', revoke: 'unknown' },
  'facebook.com': { url: 'https://www.facebook.com/settings?tab=security', label: 'Where you are logged in', revoke: 'unknown' },
  'instagram.com': { url: 'https://www.instagram.com/session/login_activity/', label: 'Login activity', revoke: 'unknown' },
  'x.com': { url: 'https://x.com/settings/sessions', label: 'Sessions', revoke: 'unknown' },
  'linkedin.com': { url: 'https://www.linkedin.com/psettings/sessions', label: 'Where you are signed in', revoke: 'unknown' },
  'dropbox.com': { url: 'https://www.dropbox.com/account/security', label: 'Devices', revoke: 'unknown' },
  'netflix.com': { url: 'https://www.netflix.com/account/security', label: 'Access and devices', revoke: 'unknown' },
  'spotify.com': { url: 'https://www.spotify.com/account/overview/', label: 'Sign out everywhere', revoke: 'unknown' },
  'twitch.tv': { url: 'https://www.twitch.tv/settings/security', label: 'Other sessions', revoke: 'unknown' },
  'zoom.us': { url: 'https://zoom.us/profile', label: 'Sign me out from all devices', revoke: 'unknown' },
  'amazon.com': { url: 'https://www.amazon.com/gp/css/homepage.html', label: 'Login & security', revoke: 'unknown' },
  'discord.com': { url: 'https://discord.com/channels/@me', label: 'Settings, Devices', revoke: 'unknown' },
  'reddit.com': { url: 'https://www.reddit.com/settings/account', label: 'Account settings', revoke: 'unknown' },
  'apple.com': { url: 'https://account.apple.com/', label: 'Devices', revoke: 'unknown' },
  'icloud.com': { url: 'https://account.apple.com/', label: 'Devices', revoke: 'unknown' },
  'paypal.com': { url: 'https://www.paypal.com/myaccount/security/', label: 'Security', revoke: 'unknown' },
